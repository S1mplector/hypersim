...
def main():
    ...
    simplex.rotate(
        xy=0.4,   # Initial XY rotation
        xw=0.3,   # Initial 4D rotation
        zw=0.2    # Initial 4D rotation
    )
